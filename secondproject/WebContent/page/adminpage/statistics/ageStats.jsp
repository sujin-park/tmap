...
<div class="container">
	<div class="col-md-4">
		...
		<button id="sendAge" onclick="javascript:getAge();">연령대별 통계</button>
		<button id="sendCategory" onclick="javascript:getCategory(0);">카테고리별 전체통계</button>
		<button id="sendCategory" onclick="javascript:getCategory(1);">카테고리별 여성통계</button>
		<button id="sendCategory" onclick="javascript:getCategory(2);">카테고리별 남성통계</button>
		<button id="sendArea" onclick="javascript:getArea();">지역별 등록된 매장수</button>
	</div>
	<div class="col-md-4">
