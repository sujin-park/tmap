...
<head>
	...
	<jsp:include page="/template/default/include/head.jsp"></jsp:include>
	<% if (addHeadPath != null) { %>
		<jsp:include page="<%=addHeadPath%>"></jsp:include>
	<% } %>
</head>
<body>
	<jsp:include page="/template/default/include/header.jsp"></jsp:include>
	<jsp:include page="<%=contentPath%>"></jsp:include>
	<jsp:include page="/template/default/include/footer.jsp"></jsp:include>
	<jsp:include page="/template/default/include/bottom.jsp"></jsp:include>
